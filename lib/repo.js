...
function Repo(owner, repo, gh) {
  this.owner = owner;
  this.repo = repo;
  this.gh = gh;
}

Repo.prototype.findDependencies = function() {
...
Repo.prototype.findManifests = function() {
...
Repo.prototype.fetchDependencies = function(manifests) {
