...
var parsers = {
  ...
  carthfile: {
    name: 'Carthage',
    type: 'manifest',
    parser: require('./carthfile'),
    filter: path => path.match(/^Carthfile$/)
  },
  carthfileprivate: {
    name: 'Carthage',
    type: 'manifest',
    parser: require('./carthfileprivate'),
    filter: path => path.match(/^Carthfile.private$/)
  },
  carthfileresolved: {
    name: 'Carthage',
    type: 'lockfile',
    parser: require('./carthfileresolved'),
    filter: path => path.match(/^Carthfile.resolved$/)
  },
